...
EXPECTED_COVERAGE="${EXPECTED_COVERAGE:-413150=installer,281990=workshop_only,107100=research_blocked}"
...
export BASE_URL REQUIRE_NO_UNSUPPORTED EXPECTED_COVERAGE
