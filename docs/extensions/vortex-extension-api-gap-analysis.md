...
- Remaining DMM catalog placeholders in `internal/extensions/vortexgamecatalog`: 18.
...
- Remaining `registerGame` placeholders: `game-fallout3`, `game-grimrock`, `game-nehrim`, `game-oblivion`, `game-prisonarchitect`, `game-sims3`, `game-skyrim`, `game-teso`.
