...
6. Extend new-file monitoring beyond extension-selected `added-files` adoption and extension-declared external unmanaged file adoption with concrete removed-file recovery handlers.
