...
func TestExtensionRegistersVortexSharedSystemRuntimeSurfaces(t *testing.T) {
	...
	assertReady(t, "extension API", summary.Capabilities.ExtensionAPIs, "deploy-single-mod", "deploy-mods", "deploy-mods-event", "purge-mods-in-path", "purge-mods", "purge-mods-event", "create-mod", "remove-mod", "remove-mods", "will-remove-mods", "will-purge", "browse-for-download", "nexus-download", "ensureLoggedIn", "nexusGetModFiles", "start-download", "start-install-download", "download-script-extender", "install-extension", "start-quick-discovery", "discover-tools", "autosort-plugins", "plugin-details", "set-plugin-list", "addToHistory", "showHistory", "did-update-masterlist", "restart-helpers", "trigger-test-run", "show-main-page", "mods-scroll-to", "enable-download-watch", "did-import-downloads", "preview-files", "analytics-track-click-event", "navigate-knowledgebase", "open-knowledge-base", "mod-content-changed", "request-own-issues", "display-report", "report-feedback", "report-log-error", "submit-feedback", "select-theme", "apply-settings", "update-conflicts-and-rules", "install-dependencies", "will-install-dependencies", "did-install-collection", "collection-postprocess-complete", "check-file-override-redundancies", "edit-mod-cycle", "recalculate-modtype-conflicts", "unfulfilled-rules", "registerGameInfoProvider", "new-file-single-owner-adoption")
