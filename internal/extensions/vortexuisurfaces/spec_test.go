...
func TestExtensionRegistersVortexUISurfaceMetadata(t *testing.T) {
	...
	if len(summary.Capabilities.ExtensionAPIs) != 13 {
	...
	assertStatus(t, "extension API", summary.Capabilities.ExtensionAPIs, "ui-await", sdk.CapabilityStatusReady)
	assertStatus(t, "extension API", summary.Capabilities.ExtensionAPIs, "state-store-access", sdk.CapabilityStatusReady)
	assertStatus(t, "extension API", summary.Capabilities.ExtensionAPIs, "native-system-access", sdk.CapabilityStatusReady)
