...
func Register(r sdk.Registrar) {
	...
	r.RegisterGameStore(sdk.GameStoreSpec{ID: "registry", Name: "Windows registry", Message: "Vortex discovers The Sims 3 through the Windows registry on Windows. DMM keeps this as an extension-declared registry provider surface while the Steam Deck target resolves The Sims 3 through Steam app 47890 and Proton Documents Packages."})
