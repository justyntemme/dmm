...
const (
	SteamAppID   = "457140"
	VortexGameID = "oxygennotincluded"
	Name         = "Oxygen Not Included"
	executable   = "OxygenNotIncluded.exe"
)
...
func sources() []sdk.SourceRef {
	return append([]sdk.SourceRef{{Name: "Vortex game-oni extension source", URL: "https://github.com/Nexus-Mods/Vortex/tree/c57894eb71af8234b58a6bd15ae5ab543eccac3a/extensions/games/game-oni/src"}}, umm.Sources()...)
}
