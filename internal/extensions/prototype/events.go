...
func didDeployTexMod(ctx context.Context, input sdk.EventHandlerInput) (sdk.EventHandlerResult, error) {
	...
	return sdk.EventHandlerResult{Notices: []sdk.EventNotice{{
		Message:     "Prototype TexMod packages were deployed. Open TexMod and select the enabled .tpf files from DMM/TexMod/Packages before launching the game through TexMod.",
