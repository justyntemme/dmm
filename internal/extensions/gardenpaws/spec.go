...
const (
	SteamAppID   = "840010"
	VortexGameID = "gardenpaws"
	Name         = "Garden Paws"
	executable   = "GardenPaws.exe"
)
...
func sources() []sdk.SourceRef {
	return append([]sdk.SourceRef{{Name: "Vortex game-gardenpaws extension source", URL: "https://github.com/Nexus-Mods/Vortex/tree/c57894eb71af8234b58a6bd15ae5ab543eccac3a/extensions/games/game-gardenpaws/src"}}, umm.Sources()...)
}
