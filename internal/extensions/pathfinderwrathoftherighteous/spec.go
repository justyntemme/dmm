...
func Register(r sdk.Registrar) {
	...
	r.RegisterGameStore(sdk.GameStoreSpec{ID: "gog", Name: "GOG", Message: "Vortex can discover Pathfinder: Wrath of the Righteous through GOG app 1207187357. DMM indexes the same extension-declared GOG identity for supported SteamOS store-provider discovery."})
