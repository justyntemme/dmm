...
var games = []GameSpec{
	...
	{VortexDir: "game-mount-and-blade", ID: "mountandblade", Name: "Mount & Blade", SteamAppIDs: []string{"22100"}, HasCustomInstallers: true, Notes: []string{"Vortex registers three active Mount & Blade games from one extension and has a commented-out Viking Conquest candidate not represented in DMM."}},
	{VortexDir: "game-mount-and-blade", ID: "mbwarband", Name: "Mount & Blade: Warband", SteamAppIDs: []string{"48700"}, NexusDomains: []string{"mbwarband"}, HasCustomInstallers: true},
	{VortexDir: "game-mount-and-blade", ID: "mbwithfireandsword", Name: "Mount & Blade: With Fire and Sword", SteamAppIDs: []string{"48720"}, NexusDomains: []string{"mbwithfireandsword"}, HasCustomInstallers: true},
	...
	{VortexDir: "game-neverwinter-nights", ID: "nwn", Name: "Neverwinter Nights", NexusDomains: []string{"neverwinter"}, AllowNoSteamAppID: true, HasCustomInstallers: true},
	{VortexDir: "game-neverwinter-nights", ID: "nwnee", Name: "Neverwinter Nights: Enhanced Edition", SteamAppIDs: []string{"704450"}, NexusDomains: []string{"neverwinter"}, HasCustomInstallers: true},
	{VortexDir: "game-neverwinter-nights2", ID: "neverwinter2", Name: "Neverwinter Nights 2", AllowNoSteamAppID: true, HasCustomInstallers: true, HasModTypes: true},
	{VortexDir: "game-nomanssky", ID: "nomanssky", Name: "No Man's Sky", SteamAppIDs: []string{"275850"}, HasModTypes: true},
	...
	{VortexDir: "game-warthunder", ID: "warthunder", Name: "War Thunder", SteamAppIDs: []string{"236390"}, HasModTypes: true},
	{VortexDir: "game-witcher", ID: "witcher", Name: "The Witcher", SteamAppIDs: []string{"20900"}, HasModTypes: true},
	{VortexDir: "game-witcher2", ID: "witcher2", Name: "The Witcher 2", SteamAppIDs: []string{"20920"}, HasModTypes: true},
