...
func Register(r sdk.Registrar) {
	...
	r.RegisterSource(sdk.SourceRef{Name: "Vortex game-subnauticabelowzero extension source", URL: "https://github.com/Nexus-Mods/Vortex/tree/" + verifiedVortexCommit + "/extensions/games/game-subnauticabelowzero/src"})
