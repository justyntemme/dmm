...
func Register(r sdk.Registrar) {
	vortexsupportmod.RegisterRootSupportMod(r, vortexsupportmod.RootSupportModSpec{GameID: VortexGameID, SteamAppIDs: []string{SteamAppID}, NexusDomains: []string{VortexGameID}, SourceName: "game-re3remake", SourceDir: "game-re3remake", SupportModID: SupportModID})
}
