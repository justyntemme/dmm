...
func Register(r sdk.Registrar) {
	...
	r.RegisterPluginActivation(gamebryo.PluginActivation(gamebryo.PluginActivationOptions{ID: "oblivion-gamebryo-plugins", Name: "Oblivion plugins.txt activation", AppDataPath: "oblivion", Format: gamebryo.FormatOriginal, NativePlugins: []string{"oblivion.esm"}}))
