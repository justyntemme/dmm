...
func CheckArchiveTools() []Tool {
	tools := []Tool{
		...
		{Name: "bsdtar", Command: "bsdtar", Description: "Extracts tar and zip archives.", InstallHint: "Install libarchive/bsdtar through a safe package source for your SteamOS setup."},
