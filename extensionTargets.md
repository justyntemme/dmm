...
| P1 | 287700 | Metal Gear Solid V: The Phantom Pain | Internal | First-party extension now registers Nexus browsing and source-verified SnakeBite `.MGSV` package detection, but blocks install because real support requires generic QAR/FPK mutation/rollback APIs for `master/0/00.dat` and `master/0/01.dat`. |
